...
import { IssueStatusCodeBreadcrumb } from "../../../../config/BreadcrumbConfig";
...
const IssueStatusCode: React.FC = observer(() => {
  const { ISSUE_STATUS_CODE_STORE } = useStore();
  const {
    list_data,
    fetchList,
    setDeleteValues,
  ...
  return (
    <>
      <BreadcrumbComponent items={IssueStatusCodeBreadcrumb.path} />
      <div className="mainPageWrap">
        <PageHeader
          className="mainPageHeader"
          title={IssueStatusCodeBreadcrumb.title}
          extra={[
...
export default IssueStatusCode;
