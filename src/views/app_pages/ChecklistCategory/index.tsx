...
import { ChecklistCategoryBreadcrumb } from "../../../config/BreadcrumbConfig";
...
const ChecklistCategory: React.FC = observer(() => {
  const { CHECKLIST_CATEGORY_STORE } = useStore();
  const {
    list_data,
    fetchList,
    setDeleteValues,
  ...
  return (
    <>
      <BreadcrumbComponent items={ChecklistCategoryBreadcrumb.path} />
      <div className="mainPageWrap">
        <PageHeader
          className="mainPageHeader"
          title={ChecklistCategoryBreadcrumb.title}
          extra={[
