...
import { ZoneBreadcrumb } from "../../../config/BreadcrumbConfig";
...
const Zone: React.FC = observer(() => {
  const { ZONE_STORE } = useStore();
  const {
    list_data,
    fetchList,
    setDeleteValues,
  ...
  return (
    <>
      <BreadcrumbComponent items={ZoneBreadcrumb.path} />
      <div className="mainPageWrap">
        <PageHeader
          className="mainPageHeader"
          title={ZoneBreadcrumb.title}
          extra={[
