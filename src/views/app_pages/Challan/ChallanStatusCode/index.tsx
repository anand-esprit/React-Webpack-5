...
import { ChallanStatusCodeBreadcrumb } from "../../../../config/BreadcrumbConfig";
...
const ChallanStatusCode: React.FC = observer(() => {
  const { CHALLAN_STATUS_CODE_STORE } = useStore();
  const {
    list_data,
    fetchList,
    setDeleteValues,
  ...
  return (
    <>
      <BreadcrumbComponent items={ChallanStatusCodeBreadcrumb.path} />
      <div className="mainPageWrap">
        <PageHeader
          className="mainPageHeader"
          title={ChallanStatusCodeBreadcrumb.title}
          extra={[
...
export default ChallanStatusCode;
