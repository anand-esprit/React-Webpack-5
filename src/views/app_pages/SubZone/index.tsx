...
import { SubZoneBreadcrumb } from "../../../config/BreadcrumbConfig";
...
const SubZone: React.FC = observer(() => {
  const { SUB_ZONE_STORE } = useStore();
  const {
    list_data,
    fetchList,
    setDeleteValues,
  ...
  return (
    <>
      <BreadcrumbComponent items={SubZoneBreadcrumb.path} />
      <div className="mainPageWrap">
        <PageHeader
          className="mainPageHeader"
          title={SubZoneBreadcrumb.title}
          extra={[
