...
const ListComponent: React.FC<any> = ({
  ...
  const { AUTH, ACO_OFFICER_SECTION_STORE } = useStore();
  const { setupGrid } = ACO_OFFICER_SECTION_STORE;
  ...
  return (
    ...
    >
      ...
      <AgGridColumn
        field="parent.nav_name"
        headerName="Parent Controller"
        cellRenderer={(props: any) => {
          return props.data.parent ? props.data.parent.nav_name : "N/A";
        }}
      />
