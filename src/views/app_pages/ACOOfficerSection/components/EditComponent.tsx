...
const EditComponent: React.FC<any> = observer(({ visible, close }) => {
  const { ACO_OFFICER_SECTION_STORE, ROOT } = useStore();
  const { EditData, editValues } = ACO_OFFICER_SECTION_STORE;
  ...
  return (
    <Modal
      centered
      title="Edit ACO Officer Section"
      width={740}
      destroyOnClose
      ...
      footer={[
        ...
        <Button
          key="1"
          disabled={disabled}
          form="editACOOfficerSectionForm"
          loading={saving}
          htmlType="submit"
          type="primary"
        >
