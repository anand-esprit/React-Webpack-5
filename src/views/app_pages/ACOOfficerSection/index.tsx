...
import { ACOOfficerSectionBreadcrumb } from "../../../config/BreadcrumbConfig";
...
const ACOOfficerSection: React.FC = observer(() => {
  const { ACO_OFFICER_SECTION_STORE } = useStore();
  const {
    list_data,
    fetchList,
    setDeleteValues,
  ...
  return (
    <>
      <BreadcrumbComponent items={ACOOfficerSectionBreadcrumb.path} />
      <div className="mainPageWrap">
        <PageHeader
          className="mainPageHeader"
          title={ACOOfficerSectionBreadcrumb.title}
          extra={[
...
export default ACOOfficerSection;
