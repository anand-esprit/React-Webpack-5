...
import { DustbinBreadcrumb } from "../../../config/BreadcrumbConfig";
...
const Dustbin: React.FC = observer(() => {
  const { DUSTBIN_STORE } = useStore();
  const {
    dustbin_data,
    fetchList,
    setDeleteValues,
  ...
  return (
    <>
      <BreadcrumbComponent items={DustbinBreadcrumb.path} />
      <div className="mainPageWrap">
        <PageHeader
          className="mainPageHeader"
          title={DustbinBreadcrumb.title}
          extra={[
