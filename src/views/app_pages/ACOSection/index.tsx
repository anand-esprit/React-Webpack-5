...
import { ACOSectionBreadcrumb } from "../../../config/BreadcrumbConfig";
...
const ACOSection: React.FC = observer(() => {
  const { ACO_SECTION_STORE } = useStore();
  const {
    list_data,
    fetchList,
    setDeleteValues,
  ...
  return (
    <>
      <BreadcrumbComponent items={ACOSectionBreadcrumb.path} />
      <div className="mainPageWrap">
        <PageHeader
          className="mainPageHeader"
          title={ACOSectionBreadcrumb.title}
          extra={[
