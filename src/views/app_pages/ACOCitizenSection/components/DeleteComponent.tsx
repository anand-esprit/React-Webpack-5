...
const DeleteComponent: React.FC<any> = observer(({ visible, close }) => {
  ...
  const { DeleteData, deleteValues } = ACL_CITIZEN_SECTION_STORE;
  ...
  return deleteValues ? (
    <Modal
      ...
      title="Delete ACO Citizen Section"
      open={visible}
    ...
    >
      <div className="deleteNote">
        Are you sure want to delete <span>{deleteValues.name}</span> Citizen
        Section?
      </div>
    </Modal>
  ) : (
