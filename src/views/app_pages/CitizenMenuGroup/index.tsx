...
import { CitizenMenuBreadcrumb } from "../../../config/BreadcrumbConfig";
...
const CitizenMenuGroup: React.FC = observer(() => {
  const { CITIZEN_MENU_GROUP_STORE } = useStore();
  const {
    list_data,
    fetchList,
    setDeleteValues,
  ...
  return (
    <>
      <BreadcrumbComponent items={CitizenMenuBreadcrumb.path} />
      <div className="mainPageWrap">
        <PageHeader
          className="mainPageHeader"
          title={CitizenMenuBreadcrumb.title}
          extra={[
...
export default CitizenMenuGroup;
