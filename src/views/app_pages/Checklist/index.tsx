...
import { ChecklistBreadcrumb } from "../../../config/BreadcrumbConfig";
...
const Checklist: React.FC = observer(() => {
  const { CHECKLIST_STORE } = useStore();
  const {
    list_data,
    fetchList,
    setDeleteValues,
  ...
  return (
    <>
      <BreadcrumbComponent items={ChecklistBreadcrumb.path} />
      <div className="mainPageWrap">
        <PageHeader
          className="mainPageHeader"
          title={ChecklistBreadcrumb.title}
          extra={[
