...
import { PriorityBreadcrumb } from "../../../config/BreadcrumbConfig";
...
const Priority: React.FC = observer(() => {
  const { PRIORITY_STORE } = useStore();
  const {
    list_data,
    fetchList,
    setDeleteValues,
  ...
  return (
    <>
      <BreadcrumbComponent items={PriorityBreadcrumb.path} />
      <div className="mainPageWrap">
        <PageHeader
          className="mainPageHeader"
          title={PriorityBreadcrumb.title}
          extra={[
