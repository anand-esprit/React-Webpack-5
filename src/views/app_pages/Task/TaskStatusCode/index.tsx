...
import { TaskStatusCodeBreadcrumb } from "../../../../config/BreadcrumbConfig";
...
const TaskStatusCode: React.FC = observer(() => {
  const { TASK_STATUS_CODE_STORE } = useStore();
  const {
    list_data,
    fetchList,
    setDeleteValues,
  ...
  return (
    <>
      <BreadcrumbComponent items={TaskStatusCodeBreadcrumb.path} />
      <div className="mainPageWrap">
        <PageHeader
          className="mainPageHeader"
          title={TaskStatusCodeBreadcrumb.title}
          extra={[
