...
const ListComponent: React.FC<any> = ({
  ...
  const { AUTH, TASK_STATUS_CODE_STORE } = useStore();
  const { ChangeStatus, setupGrid } = TASK_STATUS_CODE_STORE;
  ...
  return (
    ...
    >
      <AgGridColumn
        ...
        minWidth={100}
      />
      <AgGridColumn field="status_name" headerName="Status Name" />
      <AgGridColumn field="code" headerName="Code" />
      <AgGridColumn field="color_code" headerName="Color Code" />
      <AgGridColumn
        field="is_active"
        headerName="Active"
