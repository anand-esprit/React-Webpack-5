...
import { InspectionAreaBreadcrumb } from "../../../config/BreadcrumbConfig";
...
const InspectionArea: React.FC = observer(() => {
  const { INSPECTION_AREA_STORE } = useStore();
  const {
    list_data,
    fetchList,
    setDeleteValues,
  ...
  return (
    <>
      <BreadcrumbComponent items={InspectionAreaBreadcrumb.path} />
      <div className="mainPageWrap">
        <PageHeader
          className="mainPageHeader"
          title={InspectionAreaBreadcrumb.title}
          extra={[
