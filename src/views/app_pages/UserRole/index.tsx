...
import { UserRoleBreadcrumb } from "../../../config/BreadcrumbConfig";
...
const UserRole: React.FC = observer(() => {
  const { USER_ROLE_STORE } = useStore();
  const {
    list_data,
    fetchList,
    setDeleteValues,
  ...
  return (
    <>
      <BreadcrumbComponent items={UserRoleBreadcrumb.path} />
      <div className="mainPageWrap">
        <PageHeader
          className="mainPageHeader"
          title={UserRoleBreadcrumb.title}
          extra={[
