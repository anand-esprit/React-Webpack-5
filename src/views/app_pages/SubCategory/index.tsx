...
import { SubCategoryBreadcrumb } from "../../../config/BreadcrumbConfig";
...
const SubCategory: React.FC = observer(() => {
  const { SUB_CATEGORY_STORE } = useStore();
  const {
    list_data,
    fetchList,
    setDeleteValues,
  ...
  return (
    <>
      <BreadcrumbComponent items={SubCategoryBreadcrumb.path} />
      <div className="mainPageWrap">
        <PageHeader
          className="mainPageHeader"
          title={SubCategoryBreadcrumb.title}
          extra={[
