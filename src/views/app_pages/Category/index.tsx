...
import { CategoryBreadcrumb } from "../../../config/BreadcrumbConfig";
...
const Category: React.FC = observer(() => {
  ...
  return (
    <>
      <BreadcrumbComponent items={CategoryBreadcrumb.path} />
      <div className="mainPageWrap">
        <PageHeader
          className="mainPageHeader"
          title={CategoryBreadcrumb.title}
          extra={[
