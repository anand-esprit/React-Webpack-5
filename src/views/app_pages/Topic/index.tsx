...
import { TopicBreadcrumb } from "../../../config/BreadcrumbConfig";
...
const Topic: React.FC = observer(() => {
  ...
  return (
    <>
      <BreadcrumbComponent items={TopicBreadcrumb.path} />
      <div className="mainPageWrap">
        <PageHeader
          className="mainPageHeader"
          title={TopicBreadcrumb.title}
          extra={[
