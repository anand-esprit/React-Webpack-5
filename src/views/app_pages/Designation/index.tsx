...
import { DesignationBreadcrumb } from "../../../config/BreadcrumbConfig";
...
const Designation: React.FC = observer(() => {
  const { DESIGNATION_STORE } = useStore();
  const {
    list_data,
    fetchList,
    setDeleteValues,
  ...
  return (
    <>
      <BreadcrumbComponent items={DesignationBreadcrumb.path} />
      <div className="mainPageWrap">
        <PageHeader
          className="mainPageHeader"
          title={DesignationBreadcrumb.title}
          extra={[
