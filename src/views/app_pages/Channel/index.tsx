...
import { ChannelBreadcrumb } from "../../../config/BreadcrumbConfig";
...
const Channel: React.FC = observer(() => {
  const { CHANNEL_STORE } = useStore();
  const {
    list_data,
    fetchList,
    setDeleteValues,
  ...
  return (
    <>
      <BreadcrumbComponent items={ChannelBreadcrumb.path} />
      <div className="mainPageWrap">
        <PageHeader
          className="mainPageHeader"
          title={ChannelBreadcrumb.title}
          extra={[
