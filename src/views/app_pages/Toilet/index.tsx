...
import { ToiletBreadcrumb } from "../../../config/BreadcrumbConfig";
...
const Toilet: React.FC = observer(() => {
  const { TOILET_STORE } = useStore();
  const {
    toilet_data,
    fetchList,
    setDeleteValues,
  ...
  return (
    <>
      <BreadcrumbComponent items={ToiletBreadcrumb.path} />
      <div className="mainPageWrap">
        <PageHeader
          className="mainPageHeader"
          title={ToiletBreadcrumb.title}
          extra={[
