...
import { ACOActionBreadcrumb } from "../../../config/BreadcrumbConfig";
...
const ACOAction: React.FC = observer(() => {
  const { ACO_ACTION_STORE } = useStore();
  const {
    list_data,
    fetchList,
    setDeleteValues,
  ...
  return (
    <>
      <BreadcrumbComponent items={ACOActionBreadcrumb.path} />
      <div className="mainPageWrap">
        <PageHeader
          className="mainPageHeader"
          title={ACOActionBreadcrumb.title}
          extra={[
