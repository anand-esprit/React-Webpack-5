...
import { ACLListBreadcrumb } from "../../../config/BreadcrumbConfig";
...
const ACLList: React.FC = observer(() => {
  const { ACL_LIST_STORE } = useStore();
  const {
    list_data,
    fetchList,
    setDeleteValues,
  ...
  return (
    <>
      <BreadcrumbComponent items={ACLListBreadcrumb.path} />
      <div className="mainPageWrap">
        <PageHeader
          className="mainPageHeader"
          title={ACLListBreadcrumb.title}
          extra={[
